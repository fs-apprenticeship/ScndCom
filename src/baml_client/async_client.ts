    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          const __stream__ = this.stream.CreateDoc(
          input,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.CreateDocAction
            } catch (error) {
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.CreateDraft(
          text,
          __baml_options__
          );
        ...
        transcript: string,userContext: string,
        __baml_options__?: BamlCallOptions<never>
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            "ParseCalendarIntent",
            {
            "transcript": transcript,"userContext": userContext
            },
            this.ctxManager.cloneContext(),
            __options__.tb?.__tb(),
            __clientRegistry__,
        ...
        __baml_options__?: BamlCallOptions<never>
          ...
          // Check if onTick is provided - route through streaming if so
          if (__options__.onTick) {
          const __stream__ = this.stream.ParseIntent(
          input,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.ParsedIntent
            } catch (error) {
            throw toBamlError(error);
            }
            }
            ...
            input: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.CreateDocAction, types.CreateDocAction>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for CreateDoc", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.CreateDocAction, types.CreateDocAction>(
                  __raw__,
                  (a): partial_types.CreateDocAction => a,
                  (a): types.CreateDocAction => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              console.error("Error in onTick callback for CreateDraft", error);
              }
              }
              };
              }
            ...
            transcript: string,userContext: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.CalendarAction, types.CalendarAction>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for ParseCalendarIntent", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.CalendarAction, types.CalendarAction>(
                  __raw__,
                  (a): partial_types.CalendarAction => a,
                  (a): types.CalendarAction => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
            ...
            input: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.ParsedIntent, types.ParsedIntent>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for ParseIntent", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.ParsedIntent, types.ParsedIntent>(
                  __raw__,
                  (a): partial_types.ParsedIntent => a,
                  (a): types.ParsedIntent => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
